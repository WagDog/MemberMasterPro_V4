class CashiersController < ApplicationController
  ...
  private
    ...
    def cashier_params
      params.require(:cashier).permit(:name, :key_code, :functions_1, :functions_2, :functions_3, :pin, :needs_sign_in, :regular_wage, :overtime_wage_1, :overtime_wage_2, :max_day_seconds, :max_day_overtime_1_seconds)
    end
end
